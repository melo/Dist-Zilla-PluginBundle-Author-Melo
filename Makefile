...
#     ABSTRACT => q[Be like MELO when you build your dists]
...
#     DISTNAME => q[Dist-Zilla-PluginBundle-Author-MELO]
#     EXE_FILES => []
...
MAKE = make
FULLEXT = Dist/Zilla/PluginBundle/Author/MELO
BASEEXT = MELO
PARENT_NAME = Dist::Zilla::PluginBundle::Author
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Dist/Zilla/PluginBundle/Author/MELO.pm \
	lib/Pod/Weaver/PluginBundle/Author/MELO.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Dist/Zilla/PluginBundle/Author
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Dist/Zilla/PluginBundle/Author
...
TO_INST_PM = lib/Dist/Zilla/PluginBundle/Author/MELO.pm \
	lib/Pod/Weaver/PluginBundle/Author/MELO.pm

PM_TO_BLIB = lib/Dist/Zilla/PluginBundle/Author/MELO.pm \
	blib/lib/Dist/Zilla/PluginBundle/Author/MELO.pm \
	lib/Pod/Weaver/PluginBundle/Author/MELO.pm \
	blib/lib/Pod/Weaver/PluginBundle/Author/MELO.pm
...
DISTVNAME = Dist-Zilla-PluginBundle-Author-MELO-0.009
...
manifypods : pure_all  \
	lib/Dist/Zilla/PluginBundle/Author/MELO.pm \
	lib/Pod/Weaver/PluginBundle/Author/MELO.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Dist/Zilla/PluginBundle/Author/MELO.pm $(INST_MAN3DIR)/Dist::Zilla::PluginBundle::Author::MELO.$(MAN3EXT) \
	  lib/Pod/Weaver/PluginBundle/Author/MELO.pm $(INST_MAN3DIR)/Pod::Weaver::PluginBundle::Author::MELO.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Be like MELO when you build your dists'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Dist-Zilla-PluginBundle-Author-MELO' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dist::Zilla: 4.300002' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dist::Zilla::Plugin::Authority: 1.005' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dist::Zilla::Plugin::Bootstrap::lib: 0.01023600' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dist::Zilla::Plugin::Bugtracker: 1.111080' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dist::Zilla::Plugin::CheckChangesHasContent: 0.003' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Dist::Zilla::Plugin::OurPkgVersion: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dist::Zilla::Plugin::PodWeaver: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dist::Zilla::Plugin::PrereqsClean: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dist::Zilla::Plugin::ReportVersions::Tiny: 1.03' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Method::Signatures: 20111020' >> META_new.yml
	$(NOECHO) $(ECHO) '  Moose: 1.01' >> META_new.yml
	$(NOECHO) $(ECHO) '  Pod::Elemental: 0.102360' >> META_new.yml
	$(NOECHO) $(ECHO) '  Pod::Elemental::Transformer::List: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Pod::Weaver: 3.101633' >> META_new.yml
	$(NOECHO) $(ECHO) '  Pod::Weaver::Plugin::Encoding: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Pod::Weaver::Plugin::StopWords: 1.001005' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Be like MELO when you build your dists",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Dist-Zilla-PluginBundle-Author-MELO",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dist::Zilla" : "4.300002",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dist::Zilla::Plugin::Authority" : "1.005",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dist::Zilla::Plugin::Bootstrap::lib" : "0.01023600",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dist::Zilla::Plugin::Bugtracker" : "1.111080",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dist::Zilla::Plugin::CheckChangesHasContent" : "0.003",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Dist::Zilla::Plugin::OurPkgVersion" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dist::Zilla::Plugin::PodWeaver" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dist::Zilla::Plugin::PrereqsClean" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dist::Zilla::Plugin::ReportVersions::Tiny" : "1.03",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Method::Signatures" : "20111020",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Moose" : "1.01",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Pod::Elemental" : "0.102360",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Pod::Elemental::Transformer::List" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Pod::Weaver" : "3.101633",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Pod::Weaver::Plugin::Encoding" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Pod::Weaver::Plugin::StopWords" : "1.001005",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Pod::Weaver::Plugin::WikiDoc" : "0.093002",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Pod::Weaver::Section::Support" : "1.001",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Test::CPAN::Meta::JSON" : "0"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.009">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Be like MELO when you build your dists</ABSTRACT>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dist::Zilla::Plugin::Authority" VERSION="1.005" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dist::Zilla::Plugin::Bootstrap::lib" VERSION="0.010236" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dist::Zilla::Plugin::Bugtracker" VERSION="1.11108" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dist::Zilla::Plugin::CheckChangesHasContent" VERSION="0.003" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dist::Zilla::Plugin::OurPkgVersion" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dist::Zilla::Plugin::PodWeaver" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dist::Zilla::Plugin::PrereqsClean" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dist::Zilla::Plugin::ReportVersions::Tiny" VERSION="1.03" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Method::Signatures" VERSION="20111020" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Moose::" VERSION="1.01" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Pod::Elemental" VERSION="0.10236" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Pod::Elemental::Transformer::List" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Pod::Weaver" VERSION="3.101633" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Pod::Weaver::Plugin::Encoding" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Pod::Weaver::Plugin::StopWords" VERSION="1.001005" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Pod::Weaver::Plugin::WikiDoc" VERSION="0.093002" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Pod::Weaver::Section::Support" VERSION="1.001" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::CPAN::Meta::JSON" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Dist/Zilla/PluginBundle/Author/MELO.pm blib/lib/Dist/Zilla/PluginBundle/Author/MELO.pm \
	  lib/Pod/Weaver/PluginBundle/Author/MELO.pm blib/lib/Pod/Weaver/PluginBundle/Author/MELO.pm 
